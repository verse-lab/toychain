...
Module Type BLOCKCHAIN_INVMISC (Import BC : BLOCKCHAIN) (Import BCF : BLOCKCHAIN_FACTS BC)
...
Axiom has_chain_func : forall n w (bc bc' : Blockchain),
...
Axiom b_in_blocksFor : forall p b w,
...
End BLOCKCHAIN_INVMISC.

Module BlockChainInvMisc (Import BC : BLOCKCHAIN) (Import BCF : BLOCKCHAIN_FACTS BC)
       (Import BCP : BLOCKCHAIN_PROTOCOL BC BCF) (Import BCS : BLOCKCHAIN_STATE BC BCF BCP)
       (Import BCN : BLOCKCHAIN_NETWORK BC BCF BCP BCS) : BLOCKCHAIN_INVMISC BC BCF BCP BCS BCN.
